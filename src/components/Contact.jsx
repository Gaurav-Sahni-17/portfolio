...
function Contact() {
  return (
    ...
    <form action="https://getform.io/f/pboxxkwa" method="POST" encType="multipart/form-data">
        <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
            ...
            <div className='flex flex-col py-2'>
                ...
                <input className='border-2 rounded-lg p-3 flex border-gray-300' type="tel" name="phone"></input>
            </div>
            </div>
            <div className='flex flex-col py-2'>
